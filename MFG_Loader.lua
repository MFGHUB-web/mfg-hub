...
--  (~40KB each, m=loadcount/m=slice from the backend), fetched in
--  parallel so each request finishes inside the executor timeout.
--  Single-body m=script remains as a fallback.
--
--  v6 differed from v1.3+ by defeating stale HTTP caching inside
